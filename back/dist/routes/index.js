...
//Orders Routes
router.get('/orders', login_controller_1.getLogin, orders_controller_1.getOrders);
...
router.get('/items/order/:id', login_controller_1.getLogin, item_order_controller_1.getItemsbyOrderId);
router.get('/items/user/:id', login_controller_1.getLogin, item_order_controller_1.getItemsbyUserId);
